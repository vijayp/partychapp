...
class StateManager:
  ...
  def iter_channel_users(self):
    for c, user_dict in self._channel_user_state:
      for u in user_dict:
        yield c, u
  ...
  def get_state(self, channel, user):
  ...
  def save(cls, filename):
    ...
    cPickle.dump(cls._instance._channel_user_state, fd)
    fd.close()
  ...
  def load(cls, filename):
    ...
    try:
      ...
      cls._instance._channel_user_state = cPickle.load(open(filename, 'rb'))
      logging.error('loaded %s channels worth of data', len(cls._instance._channel_user_state))
    except:
...
#                           pshow='dnd'
  ...
  def start_session(self, *args, **kwargs):
    ...
    for c,u in StateManager.instance().iter_channel_users():
